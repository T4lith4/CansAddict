...
cansPrices = {
			    ...
			    can1: "Audio Technica ATH-M60-X R4295.00 (R644.25 VAT)",

			    can2: "Marshall Bluetooth Monitor R2999.00 (R449.85 VAT)",

			    can3: "Bose QuietComfort 35 Series II R7990.00 (R1198.50 VAT)",

			    can4: "Apple Beats Studio 3 R5899.00 (R884.85 VAT)",
...
function showCollectForm() {
    		...
    		cartPrice.innerHTML = "Total: R" + collectSum + " (R15.00 charge for collection has been added)";
    		PriceStyler();
	   }
...
function showDeliverForm() {
    			...
    			cartPrice.innerHTML = "Total: R" + deliverSum + " (R180.00 charge for delivery has been added)";
    			PriceStyler();
			 }
